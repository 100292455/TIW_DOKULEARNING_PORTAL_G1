...
<html>
	<head>
		...
		<title>Practica TIW: Alta de cursos</title>
		<meta charset="UTF-8">
		...
		<style type="text/css">
			...
			<!-- ******************** TO-DO ******************** -->
			<!-- RESCATAR ID DEL PROFESOR CORRESPONDIENTE Y PASARLO EN EL POST A AltaCursosServlet -->
			<!-- *********************************************** -->
			...
			<header>
				...
				<nav>
					<ul>
						...
						<li id = "menu-ofertas"><a href = "#">MIS OFERTAS</a></li>
					</ul>	
				</nav>
						...
						<!-- recorremos todos los objetos de la coleccion cursos 
							...
							<li id = "oferta-ejemplo">
								...
								<!-- TO-DO
									...
									<p class = "ofertas-salario">Nivel ${curso.TIPO_dificultad }</p>
								</div>
