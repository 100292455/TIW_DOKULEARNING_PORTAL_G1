...
*/
	...
	@Override
	public Collection<Cupon> recuperarCuponPorCurso(int id_curso) {
		return em.createQuery("select c from Cupon c where c.curso.ID_curso="+id_curso, Cupon.class).getResultList();
	}
